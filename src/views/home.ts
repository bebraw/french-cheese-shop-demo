                  ...
                  <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div class="min-w-0 flex-1">
                      <div class="mb-3 rounded-[1rem] border border-app-line bg-app-canvas px-4 py-3">
                        ...
                        <p id="room-lecturer-status" class="mt-2 text-sm leading-6 text-app-text-soft">The shared search query and challenge changes stay unlocked only after the lecturer claims control on this device.</p>
