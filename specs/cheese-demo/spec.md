...
- [ ] `GET /` lets the lecturer enable a local simple mode for short demos that hides Context, keeps all challenge controls available, and narrows Challenge 1 to the clearest vote choices.
